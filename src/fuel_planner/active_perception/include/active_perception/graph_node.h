...
public:
  ...
  ViewNode(const Vector3d& p, const double& pitch, const double& yaw);
  ViewNode() {
  }
  ~ViewNode() {
  }
  ...
  static double computeCostNew(const Vector3d& p1, const Vector3d& p2, const double& yaw1, const double& yaw2,
