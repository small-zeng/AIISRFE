...
from render.model.embedder import *
from render.model.density import LaplaceDensity
from render.model.ray_sampler import ErrorBoundSampler
...
class MonoSDFNetwork(nn.Module):
    ...
    def forward(self, input, indices,device=device):
